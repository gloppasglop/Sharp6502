...
namespace C6502.Tests
{
    ...
    public class BNE_RELATIVE
    {

        private Computer testComputer = new Computer();
        private uint opcode = 0xD0;
        private int cycles = 2;
        private int bytes = 2;


        [Fact]
        public void BNE_NotTakenShouldWork()
        {
        ...
        [Fact]
        public void BNE_ForwardTakenSamePageShouldWork()
        {
            testComputer.MemoryReset();
        ...
        [Fact]
        public void BNE_ForwardTakenDifferentPageShouldWork()
        {
            testComputer.MemoryReset();
        ...
        [Fact]
        public void BNE_BackwardTakenSamePageShouldWork()
        {
            testComputer.MemoryReset();
        ...
        [Fact]
        public void BNE_BackwardTakenDifferentPageShouldWork()
        {
            testComputer.MemoryReset();
