...
namespace C6502.Tests
{
    ...
    public class BVC_RELATIVE
    {

        private Computer testComputer = new Computer();
        private uint opcode = 0x50;
        private int cycles = 2;
        private int bytes = 2;


        [Fact]
        public void BVC_NotTakenShouldWork()
        {
        ...
        [Fact]
        public void BVC_ForwardTakenSamePageShouldWork()
        {
            testComputer.MemoryReset();
        ...
        [Fact]
        public void BVC_ForwardTakenDifferentPageShouldWork()
        {
            testComputer.MemoryReset();
        ...
        [Fact]
        public void BVC_BackwardTakenSamePageShouldWork()
        {
            testComputer.MemoryReset();
        ...
        [Fact]
        public void BVC_BackwardTakenDifferentPageShouldWork()
        {
            testComputer.MemoryReset();
