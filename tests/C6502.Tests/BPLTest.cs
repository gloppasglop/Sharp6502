...
namespace C6502.Tests
{
    ...
    public class BPL_RELATIVE
    {

        private Computer testComputer = new Computer();
        private uint opcode = 0x10;
        private int cycles = 2;
        private int bytes = 2;


        [Fact]
        public void BPL_NotTakenShouldWork()
        {
        ...
        [Fact]
        public void BPL_ForwardTakenSamePageShouldWork()
        {
            testComputer.MemoryReset();
        ...
        [Fact]
        public void BPL_ForwardTakenDifferentPageShouldWork()
        {
            testComputer.MemoryReset();
        ...
        [Fact]
        public void BPL_BackwardTakenSamePageShouldWork()
        {
            testComputer.MemoryReset();
        ...
        [Fact]
        public void BPL_BackwardTakenDifferentPageShouldWork()
        {
            testComputer.MemoryReset();
