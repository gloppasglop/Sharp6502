...
namespace C6502.Tests
{
    ...
    public class CPX_IMMEDIATE
    {

        private Computer testComputer = new Computer();
        private uint opcode = 0xE0;
        ...
        public void CPX_GreaterShouldWork(uint X,uint value)
        {
            ...
            Assert.Equal((X-value) & (uint) StatusFlagsMask.N, testComputer.cpu.P & (uint) StatusFlagsMask.N);
        ...
        public void CPX_SmallerShouldWork(uint X, uint value)
        {
            testComputer.MemoryReset();
        ...
        public void CPX_EqualShouldWork(uint X, uint value)
        {
            testComputer.MemoryReset();
    ...
    public class CPX_ZEROPAGE
    {

        private Computer testComputer = new Computer();
        private uint opcode = 0xE4;
    ...
    public class CPX_ABSOLUTE
    {

        private Computer testComputer = new Computer();
        private uint opcode = 0xEC;
