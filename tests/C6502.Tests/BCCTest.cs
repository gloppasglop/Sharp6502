...
namespace C6502.Tests
{
    ...
    public class BCC_RELATIVE
    {

        private Computer testComputer = new Computer();
        private uint opcode = 0x90;
        private int cycles = 2;
        private int bytes = 2;


        [Fact]
        public void BCC_NotTakenShouldWork()
        {
        ...
        [Fact]
        public void BCC_ForwardTakenSamePageShouldWork()
        {
            testComputer.MemoryReset();
        ...
        [Fact]
        public void BCC_ForwardTakenDifferentPageShouldWork()
        {
            testComputer.MemoryReset();
        ...
        [Fact]
        public void BCC_BackwardTakenSamePageShouldWork()
        {
            testComputer.MemoryReset();
        ...
        [Fact]
        public void BCC_BackwardTakenDifferentPageShouldWork()
        {
            testComputer.MemoryReset();
